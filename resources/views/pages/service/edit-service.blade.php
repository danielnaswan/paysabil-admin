        ...
        <div class="card-body pt-4 p-3">
            <form action="{{ route('service.update', $service->id) }}" method="POST" role="form text-left">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="vendor-select" class="form-control-label">Vendor</label>
                            <select class="form-control" id="vendor-select" name="vendor_id" required>
                                @foreach($vendors as $vendor)
                                    <option value="{{ $vendor->id }}" {{ $vendor->id === $service->vendor_id ? 'selected' : '' }}>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" id="preparation_time" name="preparation_time" 
                                   value="{{ old('preparation_time', $service->preparation_time) }}" required>
                ...
                <div class="d-flex justify-content-end mt-4">
                    <a href="{{ route('vendor.show', $service->vendor_id) }}" class="btn btn-light m-0 me-2">Cancel</a>
                    <button type="submit" class="btn bg-gradient-primary m-0">Update Menu Item</button>
                </div>
            </form>
        </div>
    </div>
