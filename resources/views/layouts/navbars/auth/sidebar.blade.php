<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            ...
            <span class="ms-3 font-weight-bold">Pay Sabil <strong>Admin</strong></span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            {{-- Student Management --}}
            <li class="nav-item">
                <a class="nav-link {{ Request::is('vendor') ? 'active' : '' }}"
                    href="{{ url('vendor') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-folder-17 text-dark text-sm opacity-10"></i>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('application') ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Sabil Application</span>
                </a>
            </li>
            ...
            {{-- Sihir Pemisah --}}
            <li class="nav-item mt-2">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">ANALYSIS</h6>
            </li>
            ...
            {{-- Sihir Pemisah --}}
            <li class="nav-item mt-2">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">QR CODE</h6>
            </li>

            {{-- Qr Code Generator --}}
            <li class="nav-item">
                <a class="nav-link {{ Request::is('qrcode') ? 'active' : '' }}"
                    href="{{ url('qrcode') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-mobile-button text-dark text-sm opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">Generate</span>
                </a>
            </li>
